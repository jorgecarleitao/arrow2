...
pub fn new_empty_array(data_type: DataType) -> Box<dyn Array> {
    match data_type {
        ...
        DataType::Boolean => Box::new(BooleanArray::new_empty(data_type)),
        ...
        DataType::Binary => Box::new(BinaryArray::<i32>::new_empty(data_type)),
        DataType::LargeBinary => Box::new(BinaryArray::<i64>::new_empty(data_type)),
...
pub fn new_null_array(data_type: DataType, length: usize) -> Box<dyn Array> {
    match data_type {
        ...
        DataType::Boolean => Box::new(BooleanArray::new_null(data_type, length)),
        ...
        DataType::Binary => Box::new(BinaryArray::<i32>::new_null(data_type, length)),
        DataType::LargeBinary => Box::new(BinaryArray::<i64>::new_null(data_type, length)),
