...
pub fn utf8_to_timestamp_ns_scalar(s: &str) -> Result<i64> {
...
mod tests {
    ...
    #[test]
    fn utf8_to_timestamp_timezone_space() -> Result<()> {
    ...
    #[test]
    #[cfg_attr(miri, ignore)] // miri does not support one of the instructions
    fn utf8_to_timestamp_no_timezone() -> Result<()> {
    ...
    fn expect_timestamp_parse_error(s: &str, expected_err: &str) {
        match utf8_to_timestamp_ns_scalar(s) {
            Ok(v) => panic!(
