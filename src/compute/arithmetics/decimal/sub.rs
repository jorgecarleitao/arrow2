...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::decimal::sub;
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::decimal::saturating_sub;
/// use re_arrow2::array::PrimitiveArray;
/// use re_arrow2::datatypes::DataType;
///
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::decimal::checked_sub;
/// use re_arrow2::array::PrimitiveArray;
/// use re_arrow2::datatypes::DataType;
///
/// let a = PrimitiveArray::from([Some(-99000i128), Some(11100i128), None, Some(22200i128)]).to(DataType::Decimal(5, 2));
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::decimal::adaptive_sub;
/// use re_arrow2::array::PrimitiveArray;
/// use re_arrow2::datatypes::DataType;
///
