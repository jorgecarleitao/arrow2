...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::add;
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::wrapping_add;
/// use re_arrow2::array::PrimitiveArray;
///
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::checked_add;
/// use re_arrow2::array::PrimitiveArray;
///
/// let a = PrimitiveArray::from([Some(100i8), Some(100i8), Some(100i8)]);
/// let b = PrimitiveArray::from([Some(0i8), Some(100i8), Some(0i8)]);
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::saturating_add;
/// use re_arrow2::array::PrimitiveArray;
///
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::overflowing_add;
/// use re_arrow2::array::PrimitiveArray;
///
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::add_scalar;
/// use re_arrow2::array::PrimitiveArray;
///
/// let a = PrimitiveArray::from([None, Some(6), None, Some(6)]);
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::wrapping_add_scalar;
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::checked_add_scalar;
/// use re_arrow2::array::Int8Array;
///
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::saturating_add_scalar;
/// use re_arrow2::array::PrimitiveArray;
///
/// let a = PrimitiveArray::from([Some(100i8)]);
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::basic::overflowing_add_scalar;
/// use re_arrow2::array::PrimitiveArray;
///
/// let a = PrimitiveArray::from([Some(1i8), Some(100i8)]);
