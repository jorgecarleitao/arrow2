...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::time::add_duration;
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::time::subtract_duration;
/// use re_arrow2::array::PrimitiveArray;
/// use re_arrow2::datatypes::{DataType, TimeUnit};
///
/// let timestamp = PrimitiveArray::from([
...
/// # Examples
/// ```
/// use re_arrow2::compute::arithmetics::time::subtract_timestamps;
/// use re_arrow2::array::PrimitiveArray;
/// use re_arrow2::datatypes::{DataType, TimeUnit};
