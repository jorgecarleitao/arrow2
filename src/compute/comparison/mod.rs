...
//! ```
//! use re_arrow2::array::{BooleanArray, PrimitiveArray};
//! use re_arrow2::compute::comparison::primitive::gt;
//!
...
//! ```
//! use re_arrow2::array::{Array, BooleanArray, PrimitiveArray};
//! use re_arrow2::compute::comparison::eq;
//!
...
//! ```
//! use re_arrow2::array::{BooleanArray, Utf8Array};
//! use re_arrow2::compute::comparison::utf8::neq_scalar;
//!
