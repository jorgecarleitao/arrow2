...
fn test_subtract_checked_overflow() {
    let a = PrimitiveArray::from([Some(4i128), Some(-99999i128)]).to(DataType::Decimal(
        DecimalType::Int128,
        5,
        2,
    ));
    let b = PrimitiveArray::from([Some(2i128), Some(1i128)]).to(DataType::Decimal(
        DecimalType::Int128,
        5,
        2,
    ));
...
fn test_subtract_adaptive() {
    ...
    let expected = PrimitiveArray::from([Some(-11099_9989i128)]).to(DataType::Decimal(
        DecimalType::Int128,
        9,
        4,
    ));
    ...
    let b = PrimitiveArray::from([Some(1111i128)]).to(DataType::Decimal(DecimalType::Int128, 5, 4));
    let result = adaptive_sub(&a, &b).unwrap();

    let expected = PrimitiveArray::from([Some(11110_8889i128)]).to(DataType::Decimal(
        DecimalType::Int128,
        9,
        4,
    ));
    ...
    let expected = PrimitiveArray::from([Some(-00000_001i128)]).to(DataType::Decimal(
        DecimalType::Int128,
        8,
        3,
    ));
